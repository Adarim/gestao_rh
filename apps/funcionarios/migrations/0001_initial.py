    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.FileField(blank=True, null=True, upload_to='documentos')),
                ('fone', models.CharField(max_length=30)),
                ('endereco', models.CharField(blank=True, max_length=50, null=True)),
                ('cidade', models.CharField(blank=True, max_length=35, null=True)),
                ('complemento', models.CharField(blank=True, max_length=35, null=True)),
